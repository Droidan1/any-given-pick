...
import { getPlayerActivity } from "@/lib/entries/activity-service";
...
export async function GET() {
  ...
  try {
    ...
    const activity = await getPlayerActivity(appUser.id);
    return NextResponse.json(
      { achievements: buildPlayerAchievements(activity.cards) },
