...
export default function PrivacyPage() {
  return (
    ...
    >
      ...
      <section>
        <h2>Why we use it</h2>
        <p>We use this information to authenticate accounts, enforce manual beta approval, calculate age eligibility, verify Indiana participation, save and score entries, prevent abuse, answer support requests, investigate errors, and maintain contest integrity.</p>
      </section>
      <section>
        <h2>Service providers</h2>
        <p>Vercel hosts the app, Neon hosts Postgres data, Clerk manages authentication and profile photos, the U.S. Census geocoder resolves a submitted coordinate to a state, ESPN supplies public schedule and score data, and Resend may deliver support and operational email. Providers process data only for their service role.</p>
      </section>
      <section>
