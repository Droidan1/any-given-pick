...
export const metadata: Metadata = {
  ...
  description: "How the Any Given Pick beta handles profile, eligibility, and contest data.",
};
...
export default function PrivacyPage() {
  return (
    ...
    >
      ...
      <section>
        <h2>Why we use it</h2>
        <p>We use this information to authenticate accounts, enforce manual beta approval, notify administrators when an account needs review, confirm approval to the account holder, calculate age eligibility, save and score entries, deliver requested contest reminders and receipts, prevent abuse, answer support requests, investigate errors, and maintain contest integrity.</p>
        <p>Your display name and autosaved team selections are visible to other approved active players on the live board while a published week is open. Your email address, birth date, and tiebreaker prediction are not included in that board.</p>
      </section>
      <section>
      ...
      <section>
        ...
        <p>Birth date, profile, and identity mappings remain while the account is active. Indiana location verification was disabled on August 20, 2026, and the app no longer requests or processes new coordinates. Legacy state-level check records and official entry eligibility snapshots may remain for contest integrity until deletion or anonymization. Rate-limit buckets expire automatically and are periodically deleted.</p>
