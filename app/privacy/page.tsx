    ...
    >
      <section>
        ...
        <ul>
          ...
          <li><strong>Email reminders:</strong> your reminder choices and delivery receipts. The app resolves your verified address from Clerk only when sending and does not copy the address into Postgres delivery records.</li>
      ...
      <section>
        <h2>Why we use it</h2>
        <p>We use this information to authenticate accounts, enforce manual beta approval, calculate age eligibility, verify Indiana participation, save and score entries, deliver requested contest reminders and receipts, prevent abuse, answer support requests, investigate errors, and maintain contest integrity.</p>
      </section>
      <section>
        <h2>Service providers</h2>
        <p>Vercel hosts the app, Neon hosts Postgres data, Clerk manages authentication and profile photos, the U.S. Census geocoder resolves a submitted coordinate to a state, ESPN supplies public schedule and score data, and Resend delivers player reminders, submission receipts, support messages, and operational email. Providers process data only for their service role.</p>
      </section>
      <section>
      ...
      <section>
        ...
        <p>You may decline the optional photo or location permission; declining location keeps participation read-only. You can turn any player email category on or off from <Link href="/profile#email-reminders">Profile → Email reminders</Link>. You may request access, correction, a portable summary, deletion, or an appeal by emailing <a href="mailto:brian@Droidan1.dev?subject=Any%20Given%20Pick%20privacy%20request">brian@Droidan1.dev</a>. We accept authenticated privacy requests for beta users regardless of whether a particular privacy statute applies.</p>
      </section>
      <section>
